...
if __name__ == "__main__":
    ...
    img_binary1 = filterGaussian(img, times = 10)
    img_binary2 = filterGaussian(img, times = 20)
    ...
    cv2.imwrite("test_kernels_mean_repeat.jpg",img_concatenate)
    cv2.imshow("Aplicacoes do filtro da media 3x3", img_concatenate)
    cv2.waitKey(0)
