...
if __name__ == "__main__":
    ...
    img_binary_1 = filterGaussian(img, kernelsize = 3)
    img_binary_2 = filterGaussian(img, kernelsize = 5)
    img_binary_3 = filterGaussian(img, kernelsize = 9)
    img_binary_4 = filterGaussian(img, kernelsize = 15)
    img_binary_5 = filterGaussian(img, kernelsize = 23)
    ...
    cv2.imwrite("test_size_kernels_gaussian.jpg",img_concatenate)
    cv2.imshow("Filtro Gaussiano", img_concatenate)
    cv2.waitKey(0)
